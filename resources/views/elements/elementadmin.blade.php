...
<nav>
    <div class="nav-wrapper white">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href="{{action('Controller@portaltohomeadmin')}}"><span class="grey-text text-darken-1">Portal</span></a></li>   
            <li><a href="{{action('Controller@logout')}}"><span class="grey-text text-darken-1">Logout</span></a></li>
        </ul>
        <ul class="side-nav" id="mobile-demo">
            <li><a href="{{action('Controller@portaltohomeadmin')}}"><span class="pink-text text-darken-4">Portal</span></a></li>   
