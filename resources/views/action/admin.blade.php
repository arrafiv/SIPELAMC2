...
@endsection @extends('elements.elementadmin') @section('content')
<div>
                ...
                <li class="active">
                    ...
                    <div class="collapsible-body">
                        <div class="row center-align">
                            ...
                            <div class="col s12 m6 l3" id="assethome"><a href="{{action('Controller@getdaftarizinadmin')}}"><img src="{{URL::to('src/assethome-04.png')}}"></a>
