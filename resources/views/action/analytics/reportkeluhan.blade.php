...
<div class="rowatasjudul">
    <div class="row" id="rownav2">
        <div class="col s12 l8" id="colnav2">
            <h5 id="judulinfo2" class="white-text">Keluhan</h5>
        </div>
    </div>
</div>
<div class="container">
            ...
            <div class="col l4 s12">
                <div class="card" id="card">
                    ...
                    <div class="card-panel blue">
                        <h1 class="center-align white-text">{!! $keluhanCountAll !!}</h1>
                    </div>
                </div>
            </div>
            <div class="col l4 s12">
                <div class="card" id="card">
                    ...
                    <div class="card-panel amber">
                        <h1 class="center-align white-text">{!! $keluhanCountThisMonth !!}</h1>
                    </div>
                </div>
            </div>
            <div class="col l4 s12">
                <div class="card" id="card">
                    ...
                    <div class="card-panel red">
                        <h1 class="center-align white-text">{!! $keluhanCountBelumDiproses !!}</h1>
                    </div>
                </div>
            </div>
        </div>
...
['Bulan', 'Jumlah'],
@foreach($keluhanCountPerBulan as $keluhan)
['{{$keluhan->bulan}}', {{$keluhan->jumlah}}],
@endforeach
]);
var options = {
chart: {
